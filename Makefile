installsqlc:
	curl -L "https://github.com/sqlc-dev/sqlc/releases/download/v1.23.0/sqlc_1.23.0_linux_amd64.tar.gz" | \
		tar -xz -C /usr/local/bin sqlc

dbip:
	curl -L https://download.db-ip.com/free/dbip-city-lite-2023-12.mmdb.gz | gunzip -c > geoip.mmdb
